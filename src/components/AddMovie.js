    ...
    return (
      <form onSubmit={this.addMovie}>
        ...
        <div className="imagePreviewDiv">
          <img className="imagePreview" src={src} />
        </div>
